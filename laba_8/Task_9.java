...
public class Task_9 {
    ...
    public static final String path = "C:\\Users\\Пётр\\IdeaProjects\\Function\\src\\laba_8\\Task_9";
    ...
    public static void enter_file(int count_school){
        Scanner scanner = new Scanner(System.in);
        String inform;
        System.out.println("Данные были взяты из файла");
        String[][] massive = new String[criteria][count_school];
        try  {
            BufferedReader file_read = new BufferedReader(new FileReader(path));
            BufferedWriter file_write = new BufferedWriter(new FileWriter(path,true));
            for (int i = 0; i < count_school; i++) {
                for (int g = 0; g < criteria; g++) {
                    inform = file_read.readLine();
                    massive[g][i] = inform;
                }
            }
            System.out.println(information_about_the_shool(massive));
            file_write.write("\n" + information_about_the_shool(massive));
            file_write.close();
    ...
    public static String information_about_the_shool(String[][] massive){
        ...
        text1 = "Количество школ по первому описанию:" + count_school_1 + "\n" + "Количество школ по второму описанию:" + count_school_2;
        return text1;
    ...
    public static void main(String[] args){
        ...
        System.out.println("Выберите тип ввода:1)Регламентированный  2)Нерагламентированный  3)Данные из файла");
